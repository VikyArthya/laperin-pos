...
export default function Create({ cabangs = [] }) {
    const [isCustomCabang, setIsCustomCabang] = React.useState(false);
    const [customCabangInput, setCustomCabangInput] = React.useState('');
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div>
                        ...
                        <p className="mt-1 text-gray-600 dark:text-gray-400">Buat kategori produk baru.</p>
                    </div>

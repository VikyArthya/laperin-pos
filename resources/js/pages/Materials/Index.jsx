            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                    <div>
                        ...
                        <p className="mt-1 text-slate-500">Kelola daftar bahan baku harian operasional Anda.</p>
                    </div>
                ...
                {/* Table Card */}
                <div className="bg-white rounded-2xl shadow-[0_2px:10px_-3px_rgba(6,81,237,0.05)] border border-slate-200 overflow-hidden">

...
import { ArrowLeft, FileText, Package, Wallet, CheckSquare } from 'lucide-react';
...
export default function Show({ laporan, itemsByCategory, stockRefillMaterials }) {
    ...
    const formatItem = (qty_terjual, qty_bawa) => {
        const terjual = Number(qty_terjual);
                                    ...
                                    {itemsByCategory['Menu Utama'].map((item) => (
                                        <div key={item.id} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                            ...
                                            <span className="font-semibold text-purple-600">
                                                {formatItem(item.qty_terjual, item.qty_bawa)}
                                            </span>
                                        </div>
                                    ))}
                                </div>
